...
export interface Expander<ValueType = DefaultValueType> {
    ...
    renderRows: (renderRows: any, rows: any, record: ValueType, index: number, indent: number, fixed: FixedType, key: Key, ancestorKeys: Key[]) => any;
...
export declare type RenderRows<ValueType> = (renderData: ValueType[], indent: number, ancestorKeys?: Key[]) => any;
