...
export declare type RenderTableRows<ValueType> = (renderRows: RenderRows<ValueType>, rows: any, record: ValueType, index: number, indent: number, fixed: FixedType, parentKey: Key, ancestorKeys: Key[]) => void;
